...
export default function ExecutiveDashboard() {
  ...
  return (
    <div className="min-h-screen bg-neutral-100 text-neutral-900 pb-20 p-6 md:p-10 space-y-8">
      {/* HERO BANNER EXECUTIVE */}
      <div className="relative bg-neutral-900 text-white py-10 px-6 md:px-12 overflow-hidden rounded-3xl shadow-xl">
        <div
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-1.5 bg-amber-400/10 border border-amber-400/20 px-3 py-1 rounded-full text-[11px] font-bold text-amber-300">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-4 rounded-3xl flex items-center gap-4 shadow-xl">
            <div className="w-12 h-12 rounded-2xl bg-amber-400 text-neutral-950 flex items-center justify-center font-black">
            ...
            <div>
              ...
              <p className="text-base md:text-lg font-black font-mono text-amber-400">
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white border border-neutral-200/80 p-5 rounded-3xl shadow-2xs space-y-2">
              ...
              <div>
                ...
                <p className="text-lg font-black font-mono text-neutral-900">
          ...
          <section className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-neutral-200/80 p-6 rounded-3xl shadow-2xs">
              <div>
