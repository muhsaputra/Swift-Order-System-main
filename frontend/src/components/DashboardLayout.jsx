        ...
        <div className="space-y-6">
          ...
          <nav className="space-y-6 pt-2">
            ...
            <div className="space-y-1.5">
              ...
              <button
                onClick={() => navigate("/dashboard/comprehensive-history")}
                className={`w-full flex items-center gap-3 px-3.5 py-3 rounded-2xl text-xs font-bold transition cursor-pointer group ${
                  isActive("/dashboard/comprehensive-history")
                    ? "bg-white text-neutral-950 shadow-lg shadow-white/5"
                    : "text-neutral-400 hover:bg-neutral-900 hover:text-white"
                }`}
              >
                <History
                  className={`w-4 h-4 ${isActive("/dashboard/comprehensive-history") ? "text-neutral-950" : "text-neutral-400 group-hover:text-white"}`}
                />
