          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-2xl pl-10 pr-4 py-2.5 text-xs text-slate-900 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 shadow-2xs font-medium transition"
              />
              {searchQuery && (
                <button
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-2xl text-xs font-bold transition shadow-lg shadow-blue-600/20 flex items-center gap-2 cursor-pointer active:scale-95"
            >
                ...
                <div key={cat} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pb-3 border-b border-slate-200">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-blue-600 text-white flex items-center justify-center shadow-md font-bold text-xs">
                        ...
                        <div>
                            ...
                            <div className="absolute top-3 right-3 flex flex-col gap-1.5 items-end">
                              ...
                              {menu.bundleOptions &&
                                menu.bundleOptions.length > 0 && (
                                  <span className="px-2.5 py-1 text-[9px] rounded-full font-black bg-blue-600 text-white shadow-md flex items-center gap-1">
                              ...
                              {menu.ingredients &&
                                menu.ingredients.length > 0 && (
                                  <span className="px-2.5 py-1 text-[9px] rounded-full font-black bg-sky-600 text-white shadow-md flex items-center gap-1">
                          ...
                          <div className="p-5 space-y-3">
                            <div className="flex items-center justify-between">
                              <h3 className="text-sm font-extrabold text-slate-900 line-clamp-1 group-hover:text-blue-600 transition">
                                {menu.name}
                              </h3>
                              {menu.sku && (
                            ...
                            <div className="pt-1 flex flex-wrap gap-1.5">
                              ...
                              {menu.ingredients &&
                                menu.ingredients.length > 0 && (
                                  <span className="text-[9px] bg-blue-50 text-blue-700 border border-blue-200 px-2 py-0.5 rounded-md font-semibold flex items-center gap-1">
                        ...
                        <div className="p-5 pt-0 flex justify-between items-center">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="bg-slate-100 hover:bg-blue-600 hover:text-white text-slate-700 p-2.5 rounded-xl text-xs font-semibold transition border border-slate-200 shadow-2xs cursor-pointer active:scale-95"
                              title="Edit Menu"
                            >
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-6 w-full max-w-md space-y-6 shadow-2xl">
              ...
              <form onSubmit={handleAddCategory} className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-medium focus:outline-none focus:border-blue-600"
                />
                <button
                  type="submit"
                  className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl text-xs font-bold cursor-pointer transition shadow-md shadow-blue-600/20"
                >
                  Tambah
                </button>
              </form>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-medium focus:outline-none focus:border-blue-600"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-mono font-medium uppercase focus:outline-none focus:border-blue-600"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="2"
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs resize-none font-medium focus:outline-none focus:border-blue-600"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-mono font-medium focus:outline-none focus:border-blue-600"
                      placeholder="25.000"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-medium cursor-pointer focus:outline-none focus:border-blue-600"
                  >
                    {categories.map((cat, idx) => (
                ...
                <div className="space-y-3 pt-4 border-t border-slate-100">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 px-3 py-1.5 rounded-xl text-[10px] font-extrabold cursor-pointer transition flex items-center gap-1"
                    >
                      ...
                      {ingredients.map((ing, idx) => (
                        ...
                        >
                          <select
                            ...
                            className="flex-1 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs font-medium cursor-pointer focus:outline-none focus:border-blue-600"
                          >
                          ...
                          <div className="flex items-center gap-1 w-32">
                            <input
                              ...
                              placeholder="Takaran"
                              className="w-full bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs font-mono font-medium focus:outline-none focus:border-blue-600"
                            />
                    ...
                    <div className="space-y-4 bg-slate-50 p-4 rounded-2xl border border-slate-200">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <button
                          ...
                          className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-xl text-[10px] font-bold cursor-pointer transition shadow-md"
                        >
                        ...
                        >
                          <div className="flex gap-2 items-center">
                            <input
                              ...
                              className="flex-1 bg-slate-50 border border-slate-200 rounded-lg px-3 py-1.5 text-xs font-semibold focus:outline-none focus:border-blue-600"
                            />
                            <button
                              type="button"
                          ...
                          <div className="space-y-2 pl-2">
                            ...
                            {opt.choices.map((choice, cIdx) => (
                              ...
                              >
                                <input
                                  ...
                                  className="flex-1 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs font-medium focus:outline-none focus:border-blue-600"
                                />
                                <input
                                  type="number"
                                  value={choice.price}
                                  ...
                                  className="w-28 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs font-mono font-medium focus:outline-none focus:border-blue-600"
                                />
                                <button
                                  type="button"
                                  onClick={() =>
                            ...
                            <button
                              ...
                              className="text-[10px] font-extrabold text-blue-600 hover:underline pt-1 block cursor-pointer"
                            >
                              + Tambah Pilihan Lain
                            </button>
                          </div>
                ...
                <div className="flex gap-3 pt-4 border-t border-slate-100">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl text-xs font-bold transition disabled:opacity-50 cursor-pointer shadow-lg shadow-blue-600/20"
                  >
                    {submitting
                      ? "Menyimpan..."
                      : editingId
